...
// <summary>LocaleHelper class</summary>
...
namespace Gnip.Client.Common
{
	public sealed class LocaleHelper
	{
		...
		public static string GetLanguageByDoubleAbbreviation(string abbreviation, bool useUppercase = false)
		{
			...
			language = (useUppercase) ? language.ToUpper() : language;
			return language;
		}
